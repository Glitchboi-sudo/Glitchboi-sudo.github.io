...
function fmtDate(s){ try{ return new Date(s+'T12:00:00').toLocaleDateString('es-MX',{year:'numeric',month:'short',day:'2-digit'}) }catch{ return s } }
...
function renderAll(items){
  ...
  sorted.forEach(post=>{
    ...
    const wrapper = link ? document.createElement('a') : document.createElement('article');
